...
// Manual added drops
add(<entity:emberroot:rootsonespriteboss>, [<minecraft:totem_of_undying> * 100, <mysticalagriculture:crafting:3>.withLore(['§6●§e Drops on damage', '§6●§e Amount scaled with damage']).withTag({ench: [{}]}) * 2000]); // Guardian of Sprites
